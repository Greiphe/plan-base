...
CREATE TABLE IF NOT EXISTS `planbasedb`.`registro` (
  ...
  `operacional` TINYINT(4) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_registro_fornecedor_idx` (`fornecedor_id` ASC) VISIBLE,
  INDEX `fk_registro_contaBancaria1_idx` (`contaBancaria_id` ASC) VISIBLE,
